...
| 0x09 | VIDEO | 电脑→音箱 | JPEG（800×480，屏幕镜像） |
| 0x0A | VIDEO_ACK | 音箱→电脑 | 空（收到一帧 VIDEO 立刻回，seq 与该帧相同） |
