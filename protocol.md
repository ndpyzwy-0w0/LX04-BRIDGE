...
```json
{
  ...
  "hudStyle": {
    "rev": 1710000000000,
    "reset": false,
    "cards": [{"key": "cpu", "title": "CPU", "metric": "cpu", "subMetric": "cpuT", "titleColor": "#8FA0BE", "valueColor": "#3DDC97"}]
  }
}
```
...
{"cmd": "hud_style", "rev": 1710000000000, "cards": [{"key": "cpu", "metric": "cpuT", "subMetric": "cores", "titleColor": "#8FA0BE", "valueColor": "#3DDC97"}]}
